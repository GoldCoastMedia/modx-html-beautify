...
$_lang['setting_htmlbeautify.remove_empty_lines_desc'] = 'Removes empty lines 
in the source code.';

$_lang['setting_htmlbeautify.remove_comments'] = 'Remove HTML Comments';
$_lang['setting_htmlbeautify.remove_comments_desc'] = 'Remove all comments 
<!-- ... --> from output.';
...
tag attributes values into double quoted " values.';
...
tags, which contents will be preserved by the output cleaning. It\'s highly 
